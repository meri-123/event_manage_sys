...
ActiveRecord::Schema[7.0].define(version: 2023_08_23_094945) do
  ...
  create_table "adminns", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_adminns_on_email", unique: true
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["management_id"], name: "index_comments_on_management_id"
  end
  ...
  add_foreign_key "comments", "managements"
end
